import {GoADropdown, GoADropdownItem, GoAFormItem, GoAInput} from "@abgov/react-components";
  ...
  return (
    <form>
      <GoAFormItem label="Basic dropdown">
        <GoAInput  onChange={onChange} name="firstname"  />
      </GoAFormItem>
      <GoAFormItem label="Basic dropdown">
        <GoAInput onChange={onChange}  name="phone"  />
      </GoAFormItem>
      <GoAFormItem label="Basic dropdown">
        <GoAInput onChange={onChange}  name="email"  />
        ...
        >
          {countries.map((country, index) => {
            return (
              <GoADropdownItem key={country.code} value={country.code} label={country.name}></GoADropdownItem>
            )
          })}
        </GoADropdown>
      </GoAFormItem>
