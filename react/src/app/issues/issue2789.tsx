    ...
    <>
      ...
      <GoabFormItem label="Dropdown with 20rem width" mb="m">
        <GoabDropdown
          ...
          onChange={(detail: GoabDropdownOnChangeDetail) => setDropdownValue1(detail.value as string || "")}
          width="20rem"
        >
      ...
      <GoabFormItem label="Dropdown with 30rem width" mb="m">
        <GoabDropdown
          ...
          onChange={(detail: GoabDropdownOnChangeDetail) => setDropdownValue2(detail.value as string || "")}
          width="30rem"
        >
          <GoabDropdownItem value="option1" label="Option 1"></GoabDropdownItem>
          <GoabDropdownItem value="option2" label="Option 2"></GoabDropdownItem>
      ...
      <GoabFormItem label="Dropdown with 50% width" mb="m">
        <GoabDropdown
          ...
          onChange={(detail: GoabDropdownOnChangeDetail) => setDropdownValue3(detail.value as string || "")}
          width="50%"
        >
          <GoabDropdownItem value="option1" label="Option 1"></GoabDropdownItem>
          <GoabDropdownItem value="option2" label="Option 2"></GoabDropdownItem>
      ...
      <GoabFormItem label="Dropdown with 100% width" mb="m">
        <GoabDropdown
          ...
          onChange={(detail: GoabDropdownOnChangeDetail) => setDropdownValue4(detail.value as string || "")}
          width="100%"
        >
          <GoabDropdownItem value="option1" label="Option 1"></GoabDropdownItem>
          <GoabDropdownItem value="option2" label="Option 2"></GoabDropdownItem>
      ...
      <div style={{ border: "1px solid #ccc", padding: "20px", marginTop: "20px" }}>
        ...
        <GoabFormItem label="25% width dropdown" mb="m">
          <GoabDropdown
            ...
            onChange={(detail: GoabDropdownOnChangeDetail) => setDropdownContainerValue(detail.value as string || "")}
          >
