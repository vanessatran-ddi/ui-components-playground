...
export const DataGrid = () => {
  ...
  const deleteSelected = () => {
    setUsers(users.filter((u) => !selectedUsers.includes(u.idNumber)));
    setSelectedUsers([]);
  };
  ...
  return (
    <div>
      ...
      {selectedUsers.length > 0 && (
        <GoabBlock mb="m">
          <GoabButton type="primary" onClick={deleteSelected}>
      ...
      <GoabDataGrid>
        <GoabTable width="100%" mb="xl" onSort={handleSort}>
          <thead>
            <tr data-gridrow>
              <th style={{ paddingBottom: 0 }} data-gridcell>
                <GoabCheckbox name="selectAll" mt="2" onChange={selectAll} checked={isSelectedAll} />
              </th>
              <th data-gridcell>
              ...
              <th data-gridcell>Actions</th>
            </tr>
          </thead>
          <tbody>
            {users.map((user) => (
              <tr key={user.idNumber} data-gridrow>
                <td data-gridcell>
                  <GoabCheckbox
                ...
                <td data-gridcell>{user.idNumber}</td>
                <td data-gridcell>{user.dataStarted}</td>
                <td data-gridcell>{user.dateSubmitted}</td>
                <td data-gridcell>
                  <GoabBadge type={getStatusBadgeType(user.status)} content={user.status} />
                </td>
                <td>
                  <GoabButton data-gridcell type="tertiary" onClick={() => onDelete(user.idNumber)}>
                    Delete
                  </GoabButton>
                  <GoabButton data-gridcell type="tertiary" onClick={() => onOpen(user.idNumber)}>
                    Open
                  </GoabButton>
                </td>
              </tr>
            ...
            <GoabBlock direction="row" gap="m" alignment="start">
              ...
              <GoabBlock direction="column" gap="s" alignment="start">
                <GoabBlock direction="row" gap="s" alignment="center">
                  <strong data-gridcell="1">{user.nameOfChild}</strong>
                  <GoabBlock data-gridcell="2">
                    <GoabBadge type={getStatusBadgeType(user.status)} content={user.status} />
                  </GoabBlock>
                </GoabBlock>
                ...
                <GoabBlock direction="row" gap="xl" alignment="start">
                  <GoabBlock direction="column" gap="s" alignment="start">
                    <GoabBlock direction="column" gap="xs" data-gridcell="4">
                      <strong>Updated</strong>
                      <span>{user.updated}</span>
                    </GoabBlock>
                    <GoabBlock direction="column" gap="xs" data-gridcell="7">
                  ...
                  <GoabBlock direction="column" gap="s" alignment="start">
                    <GoabBlock direction="column" gap="xs" data-gridcell="5">
                      <strong>Email</strong>
                      <span>{user.email}</span>
                    </GoabBlock>
                    <GoabBlock direction="column" gap="xs" data-gridcell="8">
                  ...
                  <GoabBlock direction="column" gap="s" alignment="start">
                    <GoabBlock direction="column" gap="xs" data-gridcell="6">
                      <strong>Program</strong>
                      <span>{user.program}</span>
                    </GoabBlock>
                    <GoabBlock direction="column" gap="xs" data-gridcell="9">
              ...
              <GoabButton type="tertiary" data-gridcell="3" onClick={() => onOpen(user.idNumber)}>
                Open
              </GoabButton>
            </GoabBlock>
          </GoabContainer>
      ...
      <GoabDataGrid>
        <GoabBlock data-gridrow>
          <GoabLink data-gridcell>
