...
@Component({
  selector: "abgov-public-form-with-datepicker",
  standalone: true,
  templateUrl: "./public-form-with-datepicker.component.html",
...
export class PublicFormWithDatePickerComponent extends PublicFormController<Page> {
  constructor() {
    super("details");
  }
